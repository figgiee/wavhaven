    ...
    <div className="max-w-screen-md mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-12 text-gray-300">
      ...
      <FAQSection title="Purchasing & Payment">
        <FAQItem question="What payment methods are accepted?">
          <p>We accept major credit cards (Visa, Mastercard, American Express) and PayPal processed securely via Stripe.</p>
        </FAQItem>
      ...
      <FAQSection title="Downloads">
        <FAQItem question="How do I access my purchased files?">
          <p>After a successful purchase, your downloadable files will be available on your <Link href="/downloads" className="text-indigo-400 hover:text-indigo-300 underline">Downloads page</Link>. You will also receive an email confirmation (for guest checkouts, this email contains your download links).</p>
        </FAQItem>
      ...
      <FAQSection title="Account Management">
        ...
        <FAQItem question="How do I manage my orders/downloads?">
          <p>Log in to your account and visit your <Link href="/downloads" className="text-indigo-400 hover:text-indigo-300 underline">Downloads page</Link> to manage your orders and downloads.</p>
        </FAQItem>
