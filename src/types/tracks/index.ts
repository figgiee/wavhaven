import type { Track, License as PrismaLicense, TrackFile, Tag, Genre, User, Mood } from '@prisma/client';
import type { License } from '../licenses'; // Import detailed License type
...
export interface Beat {
  ...
  export type TrackListItem = Pick<
    Track,
    'id' | 'title' | 'slug' | 'bpm' | 'key' | 'isPublished' | 'createdAt'
  > & {
  ...
  > & {
    ...
    tags?: { id: string; name: string }[]; // Include tags as a relation
  };
